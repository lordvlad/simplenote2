...
(function() {
  var $doc, $win, Node, SimpleNote, Tag, author, date, delay, email, github, hash, intersect, interval, isArr, isDate, isFn, isNum, isObj, isStr, k, koMap, maxScreenWidthForMobile, now, obs, revive, sizeOf, store, time, timeout, uuid, version,
  ...
  */
  ...
  SimpleNote = (function() {
    ...
    SimpleNote.prototype.revive = function() {
      ...
      this.root = (_ref = store.get('root')) != null ? _ref : new Node({
        id: 'root',
        title: 'home'
      });
    ...
    SimpleNote.prototype.save = function() {
      ...
      this.timeout = timeout.set(100, function() {
        ...
        return store.set('archive', (_ref = _this.archive) != null ? _ref.toJSON() : void 0);
      });
      return this;
    };
    ...
    SimpleNote.prototype.selectionEditDeadlines = function() {
      var d, node, _i, _len, _ref, _results;
  ...
  Node = (function() {
    function Node(options) {
      ...
      this.visible = obs(function() {
        ...
        _ref = _this.model.realFilter(), tags = _ref.tags, words = _ref.words;
