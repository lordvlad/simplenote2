...
(function() {
  var Bookmark, Node, SimpleNote, Tag, author, date, delay, email, github, hash, intersect, interval, isArr, isDate, isFn, isNum, isObj, isStr, jump, keys, koMap, maxScreenWidthForMobile, now, obs, revision, revive, sizeOf, statusDef, store, time, timeout, title, uuid, version, _ref,
  ...
  SimpleNote = (function() {
    ...
    function SimpleNote(element) {
      ...
      hash.subscribe(function(id) {
        ...
        if ((_ref1 = _this.current()) != null) {
          _ref1.editingNote(true);
        }
        return title(_this.current().title());
      });
    }
    ...
    SimpleNote.prototype.revive = function() {
      ...
      delay(function() {
        ...
        store.get('tags');
        store.get('bookmarks');
        return _this.archive = (_ref2 = store.get('archive')) != null ? _ref2 : new Node({
          id: 'archive',
          title: 'archive'
        });
      });
    ...
    SimpleNote.prototype.save = function() {
      ...
      this.timeout = timeout.set(100, function() {
        ...
        store.set('bookmarks', _this.bookmarks());
  ...
  */
  ...
  Bookmark = (function() {
    ...
    function Bookmark(options) {
      this.toJSON = __bind(this.toJSON, this);      this.model = SimpleNote.activeInstance;
  ...
  */
  ...
  (function($, view, model) {
    ...
    return $(function() {
      ...
      if ((_ref1 = model.nodes()[0]) != null) {
        if (typeof _ref1.active === "function") {
          if (typeof (_base = _ref1.active(true)).editingTitle === "function") {
            _base.editingTitle(true);
          }
        }
      }
      null;
