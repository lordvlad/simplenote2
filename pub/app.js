...
(function() {
  var Node, SimpleNote, Tag, delay, hash, interval, isArr, isDate, isFn, isNum, isObj, isStr, koMap, now, obs, revive, sizeOf, store, time, timeout, uuid,
  ...
  */
  ...
  (function($, view, model) {
    return $(function() {
      ...
      return $('#tagsMenu', view).data('smplnt-reference', null).on('call', function(e, node, o) {
        var $this;
