...
(function($,ko){
  ...
  $.extend(true, ko.observableArray.fn, {
    ...
    filter : function(a,b){
      return this().filter(a.call?a:function(n){if(a.test){return a.test(n);}var x=((n[a]&&n[a].call)?n[a]():n[a]);return b?(b.test?b.test(x):x===b):!!x;});
    },
    ...
    // @param {Mixed} a object to look for
    has : function(a){
